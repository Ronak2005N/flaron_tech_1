...
// ============================================
const animalSVGs = {
  dragon: `<img src="images/dragon.png" alt="Dragon" style="width: 100%; height: 100%; object-fit: contain;" />`,
...
(function initAboutSection() {
  ...
  slides.forEach((slide, i) => {
    ...
    slideTl.fromTo(slide, { opacity: 0 }, { opacity: 1, duration: 0.3 })
      ...
      .to({}, { duration: 0.4 })
      // Exit
      .to(slide, { opacity: 0, y: -40, duration: 0.3, ease: 'power2.in' });
